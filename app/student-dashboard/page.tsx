      ...
      <main className="container mx-auto px-4 pt-24 pb-12 space-y-8">
        ...
        <div className="space-y-2">
          <h1 className="text-3xl md:text-4xl font-bold bg-gradient-to-r from-slate-900 to-slate-700 bg-clip-text text-transparent">
            Bonjour, {user?.firstName || user?.display_name || "Étudiant"}
          </h1>
        ...
        {/* Cartes de Statistiques - AVEC QUIZ RÉUSSIS ET ÉCHOUÉS */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
          ...
          <Card className="group relative overflow-hidden bg-white hover:shadow-xl transition-all duration-300 border-slate-200">
            ...
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-3">
              ...
              <div className="h-11 w-11 rounded-xl bg-blue-50 flex items-center justify-center group-hover:bg-blue-100 transition-colors">
            ...
            <CardContent>
              ...
              <p className="text-xs text-slate-500 mt-2">Total des cours</p>
            </CardContent>
          </Card>
          ...
          <Card className="group relative overflow-hidden bg-white hover:shadow-xl transition-all duration-300 border-slate-200">
            ...
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-3">
              ...
              <div className="h-11 w-11 rounded-xl bg-green-50 flex items-center justify-center group-hover:bg-green-100 transition-colors">
          ...
          <Card className="group relative overflow-hidden bg-white hover:shadow-xl transition-all duration-300 border-slate-200">
            ...
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-3">
              ...
              <div className="h-11 w-11 rounded-xl bg-red-50 flex items-center justify-center group-hover:bg-red-100 transition-colors">
            ...
            <div className="space-y-3">
              {recentActivities.length > 0 ? (
                recentActivities.map((activity) => (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="font-semibold text-base text-slate-900 truncate group-hover:text-primary transition-colors">
                        {activity.title}
                      </p>
                ...
                <div className="text-center py-16">
                  <div className="h-20 w-20 rounded-2xl bg-gradient-to-br from-slate-100 to-slate-200 mx-auto mb-4 flex items-center justify-center">
