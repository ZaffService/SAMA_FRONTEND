        ...
        <div className="absolute inset-0 flex items-start justify-center px-5 z-10 pt-16">
          <div className="w-full max-w-md space-y-5">
            ...
            <div className="pt-2 flex flex-col gap-3">
              ...
              {/* Stats alignées sur la largeur des boutons */}
              <div className="flex w-full items-center justify-between gap-3 rounded-2xl border border-white/20 bg-[#0b2f6f]/80 px-4 py-3 text-white mt-2">
      ...
      <div className="hidden lg:block relative w-full h-[95vh] min-h-[750px] bg-gradient-to-br from-[#1e3a8a] via-[#2563eb] to-[#3b82f6]">
        ...
        <div className="absolute inset-0 flex items-center justify-start px-8 md:px-16 lg:px-20 xl:px-32 z-10">
          <div className="max-w-3xl w-full">
            ...
            {/* Boutons + stats dans le même bloc pour aligner les largeurs */}
            <div className="flex flex-col gap-40 w-fit">
              {/* Boutons */}
              ...
              {/* Stats — même largeur que les boutons grâce au w-full dans le flex col w-fit */}
              <div className="flex w-full items-center justify-between gap-6 rounded-2xl border border-white/20 bg-white/10 px-6 py-4 text-white backdrop-blur-sm">
                {heroStats.map((stat, index) => (
                  <div
                    key={stat.label}
