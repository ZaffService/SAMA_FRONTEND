...
export function CourseProgress({ modules, courseTitle }: CourseProgressProps) {
  const { overallProgress, isCompleted, stats } = useCourseProgress({ modules });
    ...
    <div className="bg-white rounded-lg border border-gray-200 p-6 space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-xl font-bold text-gray-900">Progression du cours</h2>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        ...
        <div className="text-center p-3 bg-gray-50 rounded-lg">
          <div className="text-2xl font-bold text-gray-600">{stats.notStartedModules}</div>
      ...
      <div className="space-y-3">
        <h3 className="text-sm font-semibold text-gray-900">Progression par module</h3>
          ...
          {modules.map((module) => (
            <div key={module.id} className="flex items-center gap-3">
              ...
              <div className="flex items-center gap-2 min-w-0">
                {module.completed && <CheckCircle className="w-4 h-4 text-green-500 flex-shrink-0" />}
      ...
      {!isCompleted && (
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
          <div className="flex items-start gap-3">
            ...
            <div>
              <h4 className="text-sm font-medium text-blue-900">Continuez votre apprentissage !</h4>
              <p className="text-sm text-blue-700 mt-1">
                Vous avez terminé {stats.completedModules} module{stats.completedModules > 1 ? 's' : ''}.
                Plus que {stats.totalModules - stats.completedModules} à finir !
              </p>
            </div>
          </div>
        </div>
