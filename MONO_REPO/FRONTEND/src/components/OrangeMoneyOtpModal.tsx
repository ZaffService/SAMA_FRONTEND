          ...
          <div className="space-y-4">
            <div className="bg-blue-50 p-4 rounded-lg">
              ...
              <p className="text-xs text-gray-600 mt-2">
                Composez ce code USSD sur votre téléphone pour générer votre code OTP
              </p>
            </div>

            <div className="bg-green-50 p-4 rounded-lg">
              <h4 className="font-semibold text-sm mb-2">Étape 2 : Entrez le code OTP reçu</h4>
              <Input
                type="text"
                placeholder="0000"
                value={otp}
              ...
              <p className="text-xs text-gray-500 mt-2">
                💡 Pour cette simulation, utilisez le code : <strong>1234</strong>
              </p>
            </div>
          </div>
